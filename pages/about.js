      ...
      <main className="p-5 min-h-smHeight md:min-h-mdHeight main">
        <section className="mb-20">
          <article className="leading-8 text-justify text-sm clear-both">
            ...
            <p>
              I am eighteen years old, born in 2004 May 30th - 5/30/2004
              (solar: 1383/3/10).
            </p>
            ...
            <p>
              I work with the react Library. I am at the mid level and my
            ...
            <p>
              The reason for my interest in programming is its endless
              challenges. I am always interested in doing new things and eager
              to learn new things.
            </p>
            <p>
